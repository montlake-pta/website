...
applyTo: 'src/**/*.mjs,src/**/*.js,src/**/*.css,scripts/build.mjs,scripts/render-wix-content.mjs,scripts/render-fundraising.mjs,scripts/page-content.mjs,scripts/render-newsletters.mjs,scripts/check-site.mjs,PRODUCT.md,DESIGN.md'
---
